...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { sensor: @reading.sensor, value: @reading.value } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { sensor: @reading.sensor, value: @reading.value } }
